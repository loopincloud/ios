...
//  NextcloudUITests
//
//  Created by Pedro Castilho on 17/02/18.
//  Copyright © 2018 TWS. All rights reserved.
//

import XCTest

class NextcloudUITests: XCTestCase {
    ...
    func testScreenshots() {
        ...
        let app = XCUIApplication()
        let notifButton = app.alerts["“Techsize” Would Like to Send You Notifications"].buttons["Allow"]
